...
function SideBar({
  ...
  return (
    <div
      className={`pl-[16px] ${
        isSidebarOpen
          ? "flex w-full px-2 max-sm:col-span-12 sm:w-[280px]"
          : "w-[80px] max-w-[150px] max-sm:hidden"
    ...
    >
      <div className="flex w-full flex-row items-center justify-between">
        <div className="flex flex-row items-center">
          ...
          <h1
            className={`logo  text-2xl font-bold text-white transition-all duration-200 ${isSidebarOpen ? "w-[120px] overflow-visible opacity-100" : "w-0 overflow-hidden opacity-0"}`}
          >
            CLEVERA
          </h1>
        </div>
        <button
          type="button"
          aria-label="Collapse"
          className="flex rounded-full border border-white p-3 text-white sm:hidden"
          name="Collapse"
